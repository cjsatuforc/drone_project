...
uint8_t RF24::write_register(uint8_t reg, uint8_t value)
{
  ...
  //IF_SERIAL_DEBUG(Serial.print("write_register(%02x,%02x)\r\n",reg,value));
...
{
 // Serial.print("STATUS\t\t = 0x%02x RX_DR=%x TX_DS=%x MAX_RT=%x RX_P_NO=%x TX_FULL=%x\r\n",
        //   status,
...
{
// Serial.print("OBSERVE_TX=%02x: POLS_CNT=%x ARC_CNT=%x\r\n",
         //  value,
         //  (value >> PLOS_CNT) & 0x0F,
        //   (value >> ARC_CNT) & 0x0F
      //    );
...
void RF24::print_byte_register(const char* name, uint8_t reg, uint8_t qty)
{
  ...
  //printf_P(PSTR(PRIPSTR"\t%c ="),name,extra_tab);
    ...
    printf("%s\t =", name);
  #else
 //   Serial.print(PRIPSTR"\t =",name);
  #endif
 // while (qty--)
 //   Serial.print(" 0x%02x"),read_register(reg++);
 // Serial.print("\r\n");
}
...
//  Serial.print("Data Rate\t = " PRIPSTR "\r\n",pgm_read_word(&rf24_datarate_e_str_P[getDataRate()]));
//  Serial.print("Model\t\t = " PRIPSTR "\r\n",pgm_read_word(&rf24_model_e_str_P[isPVariant()]));
//  Serial.print("CRC Length\t = " PRIPSTR "\r\n",pgm_read_word(&rf24_crclength_e_str_P[getCRCLength()]));
//  Serial.print("PA Power\t = " PRIPSTR "\r\n",  pgm_read_word(&rf24_pa_dbm_e_str_P[getPALevel()]));
...
void RF24::errNotify(){
	...
	//  Serial.print("RF24 HARDWARE FAIL: Radio not responding, verify pin connections, wiring, etc.\r\n");
	#endif
